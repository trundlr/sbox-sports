...
public partial class FootballPlayer : BasePlayer
{
	...
	{
		var startTracePosition = Position + Vector3.Up * 32;
		var tr = Trace.Sphere( 25, startTracePosition, startTracePosition + Rotation.Forward * 100 ).Ignore( this ).EntitiesOnly().Run();
